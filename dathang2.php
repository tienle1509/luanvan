...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style-dathang2.css">
				...
				<div class="ht-thanhtoan">
					...
					<div class="col-md-11 col-sm-11">
						<table class="table table-bordered">
							<tbody>
								<tr>
									<td class="row-img"><img src="img/shipper.png"></td>
									<td>
				...
				<div class="ht-thanhtoan">
					...
					<div class="col-md-11 col-sm-11">
						<table class="table table-bordered">
							<tbody>
								<tr>
									<td class="row-img"><img src="img/iconthe.png"></td>
									<td>
			...
			<div class="content-donhang row">
				<div class="row chitietsp">
					<div class="col-md-3 col-sm-3">
						<img src="sanpham/galaxyj7_1.jpg">
					</div>
