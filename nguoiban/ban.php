...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/stylelogin-nguoiban.css">
...
<body>
	...
	<div class="container-fuild panel-logan">
	...
	<div class="container-fuild">
		<div class="col-md-6">
			...
			<img src="../img/banerban.png" alt="baner-ban">
		</div>
		<div class="col-md-4">
			<form id="register" role="form">
			  ...
			  <a href="xacnhanquamail.php">Chuyển trang</a>
			</form>
		</div>
