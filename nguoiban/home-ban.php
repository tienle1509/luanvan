					...
					<div class="col-md-3 col-sm-3">
						<div class="panel panel-green">
						  <div class="panel-heading">
						  	<div class="row">
							  	<div class="col-md-3 col-sm-3">
							  		<span class="fa fa-check" style="font-size: 70px; color: white"></span>
							  	</div>
							  	<div class="col-md-9 col-sm-9 text-right">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td class="hanhdong-pro">
				        	<a href="editProduct" type="btn" class="btn btn-primary">
				        		<span class="fa fa-refresh"></span>&nbsp;&nbsp;Sửa
				        	</a>
				        	<a href="deleteProduct" type="btn" class="btn btn-danger">
